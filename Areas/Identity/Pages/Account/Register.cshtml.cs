...
namespace EcoShare.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.NumeroTelefone = Input.NumeroTelefone;
                ...
                if (result.Succeeded)
                {
                    var role = Input.TipoUsuario == TipoUsuario.FORNECEDOR? "Fornecedor Pendente" : "Consumidor";
